    ...
    >
      ...
      >
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Breeze Kitchen"
          {...getOverrideProps(overrides, "Breeze Kitchen")}
        ></Text>
      </Flex>
      <Flex
        gap="32px"
      ...
      >
        <Image
          ...
          borderRadius="160px"
          padding="0px 0px 0px 0px"
          src="https://res.cloudinary.com/crunchbase-production/image/upload/c_lpad,h_256,w_256,f_auto,q_auto:eco,dpr_1/ke65evzkoawpiz1selzv"
